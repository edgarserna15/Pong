...
public class Pong implements KeyListener, ActionListener{
	...
	public int gameStatus = 0, scoreLimit = 5, playerWon; //0 = Menu, 1 = Paused, 2 = play, 3 = Game over
	...
	public void render(Graphics2D g){
		...
		if(gameStatus == 0){
			...
			if(!selectingDifficulty){
				...
				g.drawString("Press Space to Play", width / 2 - 170, height / 2 - 25);
		...
		if(gameStatus == 1 || gameStatus == 2){
			...
			g.drawString(String.valueOf(player2.score), width / 2 + 50, 50);
	...
	public void keyPressed(KeyEvent event){
		...
		else if(event.getKeyCode() == KeyEvent.VK_ESCAPE && (gameStatus == 2 || gameStatus == 3)){
			gameStatus = 0;
		}
		else if(event.getKeyCode() == KeyEvent.VK_SHIFT && gameStatus == 0){
			bot = true;
